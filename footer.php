            <footer class="footer pv-large">
				<div class="footer__gradient"></div>

				<div class="footer__inner section section--large">
					<div class="footer__col">
						<a class="logo logo--has-txt" href="<?= home_dir(); ?>">
					...
					<div class="footer__col txt-styles">
						<p>
							<a href="mailto:hello@shrine.studio">hello@shrine.studio</a>
						</p>

						<p>
							<a href="tel:+447519767576">+44 7519 767576</a>
						</p>

						<address>Shrine Studio Ltd.<br>17 1 Tariff Street<br>Manchester, M1 2FF</address>
					</div>
				</div>
			</footer>
		</div>
